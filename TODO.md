# TODO - New UI across pages + smooth theme transitions

- [ ] Step 1: Add smooth CSS transitions for theme changes in `Frontend/css/styles.css` (dark/light), respecting `prefers-reduced-motion`.
